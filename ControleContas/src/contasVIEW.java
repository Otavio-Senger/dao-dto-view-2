...
public class contasVIEW extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Pago(1 para pago!!!)");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtPago, javax.swing.GroupLayout.PREFERRED_SIZE, 278, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel1)
                            .addComponent(jLabel4)
                            .addComponent(jLabel3)
                            .addComponent(txtDataVencimento, javax.swing.GroupLayout.PREFERRED_SIZE, 278, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(0, 0, Short.MAX_VALUE))
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(txtValor, javax.swing.GroupLayout.PREFERRED_SIZE, 278, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public void cadastrar() {
        try {
            ...
            contasdto.setDescricao(txtDescricao.getText());
            contasdto.setValor(Double.parseDouble(txtValor.getText()));

            SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
            Date dataVencimento = sdf.parse(txtDataVencimento.getText());
            contasdto.setDataVencimento(dataVencimento);

            contasdto.setPago(Integer.parseInt(txtPago.getText()));
            

            contasdao.exibir(contasdto);

        } catch (ParseException e) {
            JOptionPane.showMessageDialog(this, "Data inválida, digite no formato 'dd//MM//yy'", "ERRO", JOptionPane.ERROR_MESSAGE);
        }
    }
