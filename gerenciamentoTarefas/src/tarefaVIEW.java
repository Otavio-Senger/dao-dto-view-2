...
public class tarefaVIEW extends javax.swing.JFrame {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtPrazo, javax.swing.GroupLayout.PREFERRED_SIZE, 189, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public void cadastrar() {
        try {
            ...
            tarefadto.setTitulo(txtTitulo.getText());
            tarefadto.setDescricao(txtDescricao.getText());

            SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
            Date prazo = sdf.parse(txtPrazo.getText());
            tarefadto.setPrazo(prazo);

            tarefadao.exibir(tarefadto);
        } catch (ParseException e) {
            JOptionPane.showMessageDialog(this, "prazo inválido, digite no formato 'dd/MM/yyyy'", "ERRO", JOptionPane.ERROR_MESSAGE);
        }
    }
